  ...
  return (
    <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
      ...
      <ul className="nav-links">
        ...
        {/* Providers see flat-fee plans; everyone else sees pricing */}
        {mounted && (role === "school" || role === "clinic" || role === "sport") ? (
          <li className={isActive("/flat-fee") ? "active" : ""}>
            <Link href="/flat-fee">Pricing</Link>
          </li>
        ) : (
...
{isLoggedIn && role !== "admin" && (
  <li className={isActive(getOrdersPath()) ? "active" : ""}>
    <Link href={getOrdersPath()}>bookings</Link>
  </li>
)}
